...
class BinaryStream extends \stdClass{
	...
	public function getBool() : bool{
		return (bool) (\ord($this->get(1)));
	}

	public function putBool($v){
		($this->buffer .= \chr((bool) $v));
	}
	...
	public function getSignedShort(){
		return (\unpack("n", $this->get(2))[1] << 16 >> 16);
	}
	...
	public function getLShort($signed = \true){
		return $signed ? (\unpack("v", $this->get(2))[1] << 16 >> 16) : (\unpack("v", $this->get(2))[1]);
	}
